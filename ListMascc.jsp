...
<div class="container">
	<br><br><br>
	<p><h5>MASCC Skoru Hesaplanan Hastalar Listelendi:</h5></p>
	
<%
	Connection cnn = DriverManager.getConnection("jdbc:mysql://localhost:3306/Ferritin","root","1234");
	Statement st = cnn.createStatement();
	String q = "select * from mascc";
